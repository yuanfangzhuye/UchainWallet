...
- (void)setChoose:(BOOL)choose{
    ...
    if (choose) {
        ...
        self.backgroundColor = _baseColor ? _baseColor : [UchainUtil mainThemeColor];
        self.layer.borderColor = [UIColor clearColor].CGColor;
    }else{
        self.mnemonicL.textColor = _baseColor ? _baseColor : [UchainUtil mainThemeColor];
        self.backgroundColor = [UIColor whiteColor];
        self.layer.borderColor = _baseColor ? _baseColor.CGColor : [UchainUtil mainThemeColor].CGColor;
    }
}
